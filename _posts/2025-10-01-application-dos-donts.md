...
* don't reply to a job ad with a canned response like "I'm interested"[^1]
* don't send a message saying "I'm interested, can you check if I am qualified?" No, I do not have that kind of time
* don't send a message that asks a question that is clearly answered in the ad already
